...
import type { SectionFeatured } from "@portfolio/sanity";

type FeaturedProps = SectionFeatured & { sectionIndex: number };
      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="flex flex-col gap-y-24 lg:gap-y-16 md:px-10 lg:px-16">
          {featuredSites?.map((site, index) => (
            <a href={site.url} target="_blank" key={index} rel="noreferrer">
